...
require (
	...
	github.com/yandex-cloud/go-genproto v0.0.0-20230502091605-c1556b468ba3 // indirect
	github.com/yandex-cloud/go-sdk v0.0.0-20230502092042-98f99e999085 // indirect
